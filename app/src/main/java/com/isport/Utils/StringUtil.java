...
//			}
    ...
    //用户名、密码合法判断
    public static boolean isLoginNumberValid(String loginNumber) {
        Pattern pattern = Pattern.compile("[_a-zA-Z][_a-zA-Z0-9]*");
        Matcher matcher = pattern.matcher(loginNumber);
        return matcher.matches();
    }

    public static boolean isLoginPasswordValid(String loginPassword) {
        return loginPassword.length() >= 6 && loginPassword.length() <= 12;
    }
